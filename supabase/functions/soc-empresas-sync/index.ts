...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // ============================================================
    // SEGUNDA CHAMADA — Cadastro de Empresas (SOCNET) — DESATIVADO
    // Mantido apenas o foco em clientes diretos da PreverMed.
    // ============================================================
    const socnetTotal = 0;
    const socnetInserted = 0;
    const socnetUpdated = 0;
    const socnetErrors: any[] = [];
    const socnetSkipped: any[] = [];
    const socnetStatusValues: string[] = [];
